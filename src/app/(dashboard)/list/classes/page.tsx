...
const ClassListPage = () => {
  ...
  const renderRow = (item:Class) => (
    <tr key={item.id} className="borber-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lamaPurpleLight">
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">All Clasess</h1>
